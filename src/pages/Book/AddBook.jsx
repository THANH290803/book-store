                                ...
                                <div className="card mb-4 col-12">
                                    ...
                                    <form className="card-body" onSubmit={handleSubmit}>
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <input type="file" className="form-control" id="inputGroupFile02" onChange={(e) => setImageUrl(e.target.value)} value={imageUrl} required />
                                        </div>
                                        <div className="mb-3">
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <textarea type="text" className="form-control" id="des1" onChange={(e) => setDescription(e.target.value)} required></textarea>
                                        </div>
                                        <div className="mb-3">
